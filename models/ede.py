...
from utils.inc_net import MyAdaptiveNet
...
class Learner(BaseLearner):
    def __init__(self, args):
        ...
        self.args = args
        self._old_base = None
        self._network = MyAdaptiveNet(args, True)
    ...
    def incremental_train(self, data_manager):
        ...
        for param in self._network.intit_extractor.parameters():
            param.requires_grad = False
    ...
    def _train(self, train_loader, test_loader):
        ...
        if self._cur_task==0:
            ...
            self.replace_fc(train_loader, self._network, None)
    ...
    def replace_fc(self,trainloader, model, args):
        ...
        with torch.no_grad():
            for i, batch in enumerate(trainloader):
                ...
                embedding = model._forward(data)['features']
        ...
        for class_index in class_list:
            ...
            self._network.cos_fc.weight.data[class_index]=proto
        return model
    
    # def construct_dual_branch_network(self):
    #     network = MyAdamCosineIncrementalNet(self.args, True)
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                if random.random() < self.args["mixup"]:
                    inputs, targets_a, targets_b, lam = self.mixup_data(inputs, targets,10, True)
